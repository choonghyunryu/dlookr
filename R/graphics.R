...
theme_typographic <- function(base_family = NULL) {
  ...
  theme_ipsum_rc(base_family = base_family)
}
...
#' @importFrom ggplot2 theme element_text element_line element_rect element_blank margin unit
theme_ipsum <- function (base_family = "Arial Narrow", base_size = 11.5, plot_title_family = base_family, 
