...
```{r plot_outlier_pipe, fig.align='center', fig.width = 7, fig.height = 5}
flights %>%
...
```{r plot_na_pareto2, fig.align='center', fig.width = 7, fig.height = 5}
mice::boys %>% 
...
```{r plot_na_pareto3, fig.align='center', fig.width = 7, fig.height = 5}
mice::boys %>% 
...
```{r plot_na_pareto4, fig.align='center', fig.width = 7, fig.height = 5}
...
```{r plot_na_hclust3, fig.align='center', fig.width = 7, fig.height = 5}
mice::boys %>%
...
```{r plot_na_hclust4, fig.align='center', fig.width = 7, fig.height = 5}
mice::boys %>%
