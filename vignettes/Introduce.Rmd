...
diagnose data quality of numerical variables | descriptive statistics, number of zero, minus, outliers | `diagnose_category()` | x
...
plot outliers information of numerical data  | box plot and histogram whith ourlers, without outliers | `plot_outlier()` | x
