...
```{r imputate_na2, fig.align='center', fig.width = 6, fig.height = 4}
library(mice)
...
```{r binning, fig.width = 8, fig.height = 6}
...
```{r binning_by, fig.width = 8, fig.height = 5, dpi=300}
library(dplyr)
...
```{r trans_agenda_html, echo=FALSE, out.width='60%', fig.align='center', fig.pos="!h", fig.cap="Data transformation report titles and table of contents"}
...
```{r trans_table_html, echo=FALSE, eval=FALSE, out.width='50%', fig.align='center', fig.pos="!h", fig.cap="Report table example (web)"}
