...
```{r plot_correlate2, fig.align='center', fig.width = 5, fig.height = 3}
# Select columns by name
...
```{r plot_correlate3, fig.align='center', fig.width = 5, fig.height = 3, warning=FALSE}
carseats %>%
  filter(ShelveLoc == "Good") %>%
  group_by(Urban) %>%
...
```{r eda_egenda_html, echo=FALSE, out.width='60%', fig.align='center', fig.pos="!h", fig.cap="EDA report titles and table of contents"}
knitr::include_graphics('img/eda_agenda_html.png')
```

* Much information is represented in tables in the report. An example of a table in the html file is shown in the following figure.

```{r eda_table_html, echo=FALSE, out.width='60%', fig.align='center', fig.pos="!h", fig.cap="EDA report table example (Web)"}
...
```{r eda_normality_html, echo=FALSE, out.width='60%', fig.align='center', fig.pos="!h", fig.cap="EDA Report Normality Test Information (Web)"}
